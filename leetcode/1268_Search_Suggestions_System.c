...
// char *test_string[] = {"mobile","mouse","moneypot","monitor","mousepad"};
// #define SEARCH "mouse"

char *test_string[] = {"bags","baggage","banner","box","cloths"};
#define SEARCH "bags"

#define LEN sizeof(test_string) / sizeof(test_string[0])
...
int main(int argc, char *argv[]) {
    ...
    int return_size = 0;
    int *col_size;
    char ***result = suggestedProducts(test_string, LEN, SEARCH, &return_size, &col_size);
